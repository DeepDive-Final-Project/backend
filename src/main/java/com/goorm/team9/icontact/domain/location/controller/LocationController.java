...
public class LocationController {
    ...
    @PostMapping("/save")
    public ResponseEntity<Map<String, Object>> saveLocation(@RequestBody LocationRequest request) {
    ...
    public ResponseEntity<Map<String, Object>> deleteLocation(@RequestBody DeleteRequest request) {
    ...
    @PostMapping("/nearby")
    public ResponseEntity<Map<String, Object>> getNearbyUsers(@RequestBody NearbyRequest request) {
        List<LocationResponse> nearbyUsers = locationService.getNearbyUsers(request.getId(), request.getRole(), request.getCareer());
    ...
    @PostMapping("/refresh")
    public ResponseEntity<Map<String, Object>> refreshNearbyUsers(@RequestBody RefreshRequest request) {
        List<LocationResponse> nearbyUsers = locationService.refreshNearbyUsers(
                request.getId(),
                request.getLatitude(),
